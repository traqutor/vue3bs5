<template>
  <div class="row section-widget position-relative flex-fill mt-3 m-2">
    <conversations
      v-if="
        conversationViewMode === conversationViewModes.VIEW &&
...
export default {
  setup() {
    ...
    const conversationViewMode = computed(
      () => store.getters.getConversationViewMode
    );
