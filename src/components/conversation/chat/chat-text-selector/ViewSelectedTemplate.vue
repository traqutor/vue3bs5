    ...
    <perfect-scrollbar class="d-flex flex-column h-100 w-100 position-absolute">
      <div class="mb-2 d-flex align-items-center pr-4">
        ...
        <div class="d-flex align-items-center">
          <button class="btn btn-sm" @click="onCancelViewSelectedTemplate()">
            Cancel
          </button>
        </div>
      </div>
                ...
                <div v-for="(item, index) in getSelectedTemplate" :key="index">
                  ...
                  >
                    <label
                      ...
                      class="
                        toggle-input toggle-input-reverse toggle-input-success
                        d-flex
                    ...
                    <div v-else class="media">
                      <span
                        ...
                        "
                        >{{ item.name && item.name.slice(0, 1) }}</span
                      >
                      <div class="media-body">
                        <div class="text-secondary f-size-13">
                          {{ item.name }}
                        </div>
                        <div
