<template>
  <div class="step-tabpanel flex-fill position-relative active show" id="dialog-content-section-4"
       style="display: block;">
    <div class="d-flex flex-column position-absolute w-100 h-100">
      ...
      <div class="chat-section-body d-flex flex-column flex-fill pt-2 mb-3 position-relative">
        <div class="d-flex flex-column position-absolute w-100 h-100 overflow-hidden">
          <div class="ps-scrollbar pr-3 ps">

            <perfect-scrollbar class="list-group list-group-flush overflow-hidden select-action-group">
...
export default {
  setup() {
    ...
    const selectedParticipants = computed(() => store.getters.getSelectedParticipants);
